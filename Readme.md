...
A distributed IoT architecture simulating a smart camera system. It performs **Edge Computing** (OCR & Audio Generation) to reduce bandwidth and utilizes a **Hybrid Database** strategy (SQL + NoSQL) for scalable data management.
...
### Step 1: Clone & Setup
```bash
git clone [https://github.com/YOUR_USERNAME/ocr-edge-pipeline.git](https://github.com/YOUR_USERNAME/ocr-edge-pipeline.git)
cd ocr-edge-pipeline